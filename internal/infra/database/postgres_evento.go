...
func (p *Postgres) atualizarEventoComPerfil(ctx context.Context, id, usuarioID, perfilCodigo string, corpo eventoService.RequisicaoEvento) (eventoService.EventoCampus, error) {
...
func (p *Postgres) removerEventoComPerfil(ctx context.Context, id, usuarioID, perfilCodigo string) error {
	if err := p.garantirDonoTabela(ctx, "eventos", id, usuarioID, perfilCodigo); err != nil {
		return err
	}
	tx, err := p.pool.Begin(ctx)
...
func (p *Postgres) AtualizarEvento(ctx context.Context, id, usuarioID string, corpo eventoService.RequisicaoEvento) (eventoService.EventoCampus, error) {
	return p.atualizarEventoComPerfil(ctx, id, usuarioID, "padrao", corpo)
}
func (p *Postgres) AtualizarEventoComoAdmin(ctx context.Context, id string, corpo eventoService.RequisicaoEvento) (eventoService.EventoCampus, error) {
	return p.atualizarEventoComPerfil(ctx, id, "", "sistema_admin", corpo)
}
func (p *Postgres) RemoverEvento(ctx context.Context, id, usuarioID string) error {
	return p.removerEventoComPerfil(ctx, id, usuarioID, "padrao")
}
func (p *Postgres) RemoverEventoComoAdmin(ctx context.Context, id string) error {
	return p.removerEventoComPerfil(ctx, id, "", "sistema_admin")
}
